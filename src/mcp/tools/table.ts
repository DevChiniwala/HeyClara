...
export const CLARA_TOOLS: NiaTool[] = [
  ...
  },
  {
    ...
    schema: {
      ...
      prompt: z
        .string()
        .optional()
        .describe("New database prompt. A non-empty ~/.heyclara/jobs/<job-name>/prompt.md overrides this at runtime."),
  ...
  },
  {
    name: "place_call",
    description:
      "Place an outbound phone call. Clara dials the number, introduces herself, and pursues the stated goal. Use for appointments, vendor follow-ups, scheduled standup calls to the owner, or anything that's faster by voice than by message.",
    schema: {
